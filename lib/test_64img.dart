...
import 'package:gotwo_app/testimg64_infor.dart';
      ...
      children: [
        ElevatedButton(
          ...
          child: Container(
            ...
            child: _image != null // ตรวจสอบว่ามีรูปภาพที่เลือกหรือไม่
                ? ClipOval(
                    // ใช้ ClipOval เพื่อทำให้รูปเป็นวงกลม
                    child: _image != null // ตรวจสอบว่า _image มีค่าหรือไม่
                        ? Image.file(
                            _image!,
                            fit: BoxFit
        ...
        Navigator.pushAndRemoveUntil(
          ...
          MaterialPageRoute(
            builder: (context) => Test_iminfr(
              ...
              imageFile: _image,
              userCardImagePath: '', // ส่ง _image ไปยังหน้า GotwoInformation
            ),
          ),
