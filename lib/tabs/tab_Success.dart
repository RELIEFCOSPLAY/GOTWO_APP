...
class TabSuccess extends StatelessWidget {
  @override
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          Text(
                            ...
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(fontSize: 15, color: Color(0xff1a1c43)),
                          ),
                          Text(
                            "THB",
                            textAlign: TextAlign.center,
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Paid",
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 10, color: Color(0xff06D258)),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Unpaid",
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 10, color: Color(0xffE51A1A)),
                      ),
                    ),
                  ],
                ),
