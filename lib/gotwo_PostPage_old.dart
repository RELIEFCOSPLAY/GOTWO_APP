...
class GotwoPostpageOld extends StatefulWidget {
  const GotwoPostpageOld({super.key});

  @override
  State<GotwoPostpageOld> createState() => _GotwoPostpageOldState();
}

class _GotwoPostpageOldState extends State<GotwoPostpageOld> {
